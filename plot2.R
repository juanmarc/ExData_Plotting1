...
# 6 Mar 2016
#
# This r code create the required plot2 for the course project based on electric power
...
plot(dtg,powerDataFeb1_2_2007$Global_active_power,type="l",xlab="",ylab="Global Active Power (kilowatts)")
dev.off()