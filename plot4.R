...
# 6 Mar 2016
#
# This r code create the required plot4 for the course project based on electric power
...
## plot the data in a four planel plot as required and write to file
png("plot4.png", width=480, height=480)
par(mfrow=c(2,2))

## upper left plot
plot(dtg,powerDataFeb1_2_2007$Global_active_power,type="l",xlab="",ylab="Global Active Power")

## uppper right plot
plot(dtg,powerDataFeb1_2_2007$Voltage,type="l",xlab="datetime",ylab="Voltage")
...
## lower right plot
plot(dtg,powerDataFeb1_2_2007$Global_reactive_power,type="l",xlab="datetime",ylab="Global_reactive_power")
dev.off()